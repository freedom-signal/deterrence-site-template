    ...
    <div className={sharedStyles.pageWrapper}>
        ...
        <div className={styles.textWrapper}>
          ...
          <Img
            ...
            />
          <p className={styles.payFines}>You might pay up to  { data.site.siteMetadata.fine } in fines, but you could lose much more than that</p>  
            <Img
            ...
            />
          <p className={styles.loseJob}>You could become a liability to your company and lose your job</p>
            <Img
            ...
            />
          <p className={styles.rethinkBuying}>Ready to rethink buying sex? There is help available for you now.</p>
